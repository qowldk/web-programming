...
if(!$_SESSION['UID']){
    echo "<script>alert('회원 전용 게시판입니다.');location.href='/course/board.php';</script>";
    exit;
}
...
if($bid){
    ...
    if($rs->userid!=$_SESSION['UID']){
        echo "<script>alert('본인 글이 아니면 삭제할 수 없습니다.');location.href='/course/board.php';</script>";
        exit;
    }
...
if($result){
    echo "<script>alert('삭제했습니다.');location.href='/course/board.php';</script>";
    exit;
}else{
